 ...
 */
final class Version20251006214008 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE quote_item (id SERIAL NOT NULL, quote_id UUID NOT NULL, description TEXT DEFAULT NULL, quantity NUMERIC(10, 2) NOT NULL, unit_price NUMERIC(10, 2) NOT NULL, tax_rate NUMERIC(5, 2) NOT NULL, total NUMERIC(10, 2) NOT NULL, title VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_8DFC7A94DB805178 ON quote_item (quote_id)');
        $this->addSql('COMMENT ON COLUMN quote_item.quote_id IS \'(DC2Type:ulid)\'');
